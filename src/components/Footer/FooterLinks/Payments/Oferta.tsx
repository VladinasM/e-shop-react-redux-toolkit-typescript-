...
const Oferta = () => {
    return (
        <section className={classes.oferta}>
            <h2 className={classes.title}>Публичная оферта</h2>
            <p>
                Данная оферта не имеет никакой юридической силы и взята для примера. Интернет-магазин «Bono», именуемый в дальнейшем «Продавец», публикует Публичную оферту о продаже Товаров дистанционным способом.
            </p>
            <div>
                <h3>1. ОПРЕДЕЛЕНИЕ ТЕРМИНОВ</h3>
                <p>1.1. Публичная оферта (далее – «Оферта») — публичное предложение Продавца, адресованное неопределенному кругу лиц, заключить с Продавцом
                    договор купли-продажи товара дистанционным способом (далее — «Договор») на условиях, содержащихся в настоящей Оферте, включая все
                    Приложения.<br/>
                    1.2. Заказ Товара на сайте Интернет-магазина – позиции указанные Покупателем из ассортимента Товара, предложенного к продаже,
            ...
            <div>
                ...
                <p>3.1. Цена на каждую позицию Товара указана на сайте Интернет-магазина.<br/>
                    ...
                    3.8. Расчеты между Продавцом и Покупателем за Товар производятся способами, указанными на сайте Интернет-магазина в разделе Оплата заказа.<br/>
                </p>
            </div>
            <div>
                <h3>4. ОФОРМЛЕНИЕ ЗАКАЗА</h3>
                <p>4.1. Заказ Товара осуществляется Покупателем через Оператора по телефону номер телефона или через сервис сайта Интернет-магазина.<br/>
            ...
            <div>
                ...
                <p>
                    Внимательно ознакомьтесь с текстом публичной оферты, и если Вы не согласны с каким-либо пунктом оферты, Вы вправе отказаться от покупки Товаров, предоставляемых Продавцом, и не совершать действий, указанный в п. 2.1. настоящей Оферты. Данная оферта была взята для примера и не имеет какой-либо юридической силы.
                </p>
            </div>
        </section>
    );
