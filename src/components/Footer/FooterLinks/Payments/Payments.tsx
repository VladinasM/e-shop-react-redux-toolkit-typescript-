        ...
        <section className={mainSection.mainSection}>
            <div className={classes.payments}>
                ...
                <p className={classes.startText}>
                    Для WooCommerce есть большое количество готовых модулей от платежных систем, которые добавляют новые
                ...
                <p className={classes.finalText}>
                    Во всех популярных платежных системах и агрегаторах есть готовые модули для WooCommerce и подробные
